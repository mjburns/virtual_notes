...
In previous experience, running the above sometimes fails. ChatGPT can be used for alternative mounting syntax. I also tried using a token to login but failed. I was hoping that the token might 'persist' (less dropouts). Could investigate this further.
